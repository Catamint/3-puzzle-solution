/*a computer for Figures' Huarong Road
*
*
*/
...
int main() {
    int square[TQS]={7,6,8,1,2,5,3,4,0};   /* 当前最多步数26 7,6,8,1,2,5,3,4,0 */
    node* answer = NULL;
    /*int square[TQS];
    for (int i = 0; i < TQS; i++){
        scanf("%d",&square[i]);
    ...
    if(completed(square)){
        printf("Have already completed....."); //首次完成检查
